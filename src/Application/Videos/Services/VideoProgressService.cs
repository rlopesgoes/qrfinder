...
//         var status = new ProcessStatus(videoId, stage, null, null, null, DateTime.UtcNow);
...
//     }
//
//     public async Task<ProcessStatus?> GetStatusAsync(string videoId, CancellationToken cancellationToken = default)
//     {
//         return await processStatusRepository.GetAsync(videoId, cancellationToken);
//     }
//
